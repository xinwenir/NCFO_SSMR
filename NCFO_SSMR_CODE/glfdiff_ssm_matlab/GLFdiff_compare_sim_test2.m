...
% test1_L_COM = 1;
test2_Ms_COM = 1;
fid  = fopen('test3\dy_rom.dat','r');
if exist('test1_L_COM','var')
    fid1 = fopen('test3\dy_rom1.dat','r');
    fid2 = fopen('test3\dy_rom2.dat','r');
    fid3 = fopen('test3\dy_rom3.dat','r');
end
% fid4 = fopen('test3\dy_rom4.dat','r');
% fid5 = fopen('test3\dy_rom5.dat','r');
...
[dy4] = GLF_L(u,t,alpha,h,512);
[dy5] = GLF_L(u,t,alpha,h,1024);
...
elseif exist('test2_Ms_COM','var')   
    legend('L-linear','L-quadratic','L=512','L=1024','PWL','PWQEF');
end
